...
- (id)specifiers {
	...
	if (_specifiers == nil) {
      ...
      @"title" : @"Herbert",
		...
		NSString *title = nil;
		_specifiers = [SpecifiersFromPlist(plist, [self specifier], self, @"herbertprefs", [self bundle], &title, &specifierID, self, nil) retain];
...
- (void)follow:(id)arg1{
  if([[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"twitter://"]]){
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"twitter://user?screen_name=PressSec"]];
  }else{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.twitter.com/PressSec"]];
  }
}
